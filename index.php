...
$staffQuery = "SELECT userID, firstName, lastName, department, branch FROM users ORDER BY department, lastName, firstName";
...
$locations = array("FrontDesk", "BackRoom", "ReferenceDesk", "Makerspace", "Lunch", "Programs/Other");
